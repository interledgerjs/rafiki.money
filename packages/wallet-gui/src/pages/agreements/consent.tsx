...
const AgreementConsent: React.FC<AgreementConsentProps> = ({consentRequest, challenge}) => {
  ...
  async function getAgreementAndMerchantDetails() {
    ...
    await axios.get(consentRequest.agreementUrl!).then(resp => {
    ...
    (
      <div className="w-full max-w-sm mx-auto mt-16 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="text-center my-4">
          Authorize <strong className="text-grey-darkest font-bold whitespace-no-wrap">{merchantName}</strong> to access your ILP Wallet Account
        </div>
        ...
        <div className="text-grey-dark font-semibold text-md mb-2 mt-4">
          Wallet
        </div>
