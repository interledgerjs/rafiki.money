...
const Navigation: React.FC<props> = (props) => {
  ...
  return (
    <div className="flex z-50 left-0 bottom-0 h-16 md:h-32 w-full md:top-0 md:h-full md:w-32 fixed bg-surface">
      <div
        className="flex flex-wrap content-center text-center justify-center items-center left-0 bottom-0 md:top-0 md:w-32 bg-surface w-full md:h-full elevation-8 bg-surface-elevation-8 md:elevation-0 md:bg-surface">
        ...
        {navItems.map(element => {
          return (
            <div onClick={() => {
              ...
              <i className={`material-icons w-full my-auto`}>{element.icon}</i>
