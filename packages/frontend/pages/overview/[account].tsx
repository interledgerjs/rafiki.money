...
const sideBar = (account: Account, token, refreshAccounts) => {
  ...
  if(account) {
    return (
      <Card flat className="flex flex-col w-full h-full sm:elevation-1">
    ...
    <div>
      ...
      <Content navigation>
        <div className="flex flex-col sm:flex-row h-full justify-center">
          <div className="hidden sm:flex flex-col w-full sm:w-2/3">
                ...
                localAccounts.map(account => {
                  return (
                    <div key={account.id} onClick={() => router.push(`/overview/${account.id}`)}>
                      <Card className="mb-8 h-32 cursor-pointer">
                        <div className="text-headline-5">
                          {account.name}
                        </div>
                        <div className="text-headline-6">
          ...
          <div className="flex h-full w-full sm:w-1/3 sm:ml-12">
